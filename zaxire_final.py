...
def user(m):
    ...
    with open("DOCUMENT.txt",'rb') as f:
        while(i<len(score)):
            ...
            print"------------------------------------------------------------------------------"
            i+=1
        x=int(input("Which DOC do you like show??"+'\n'+"if yo don't like please enter -1"+'\n'))
        if(x>len(score)): print "not fuond any document"
        _string=str()
        while(x!=-1):
            if(x>len(score)): print "not fuond any document"
            ...
            codebox(msg='GOOD LOCK', title='DOCUMENT', text=_string)
            _string=str()
            print"--------------------------------------------------------------------------------------"
            x=int(input("Which DOC do you like show??"+'\n'+"if yo don't like please enter -1"+'\n'))
